...
export default function App() {
  ...
  const handleEnterDashboard = () => {
    ...
    toast.success('Welcome to AI CropAdvisor Dashboard!');
  };

  const handleBackToLanding = () => {
    setCurrentView('landing');
    setActiveTab('overview');
    toast.info('Returned to landing page');
  };
  ...
  const handleStartDemo = (demoType: string) => {
    ...
    switch (demoType) {
      case 'ai-recommendations':
        ...
        toast.success('AI Recommendations demo started!');
        break;
      case 'disease-detection':
        setActiveTab('overview');
        toast.success('Disease Scanner demo activated!');
        break;
      ...
      case 'satellite-monitoring':
        ...
        toast.success('Satellite Monitoring demo started!');
        break;
      case 'offline-mode':
      ...
      case 'market-analysis':
        ...
        toast.success('Market Analysis demo started!');
        break;
      default:
        setActiveTab('demo');
        toast.success('Live demo started!');
    }
  };
  ...
  const handleNavigate = (section: string) => {
    ...
    toast.info(`Navigated to ${section.charAt(0).toUpperCase() + section.slice(1)}`);
  };

  const handleVoiceToggle = (active: boolean) => {
    setIsVoiceActive(active);
    toast.success(active ? 'Voice Assistant activated!' : 'Voice Assistant deactivated!');
  };

  const handleChatToggle = (open: boolean) => {
    setIsChatOpen(open);
    toast.success(open ? 'AI Chat opened!' : 'AI Chat closed!');
  };

  const handleOfflineToggle = () => {
    const newOfflineState = !isOfflineMode;
    setIsOfflineMode(newOfflineState);
    toast.success(newOfflineState ? 'Offline Mode enabled!' : 'Online Mode enabled!');
  };
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="grid w-full grid-cols-6 bg-slate-800/50 border border-slate-700">
            <TabsTrigger 
              ...
              onClick={() => toast.info('Overview section loaded')}
            >
            ...
            <TabsTrigger 
              ...
              onClick={() => toast.info('Live Demo section loaded')}
            >
            ...
            <TabsTrigger 
              ...
              onClick={() => toast.info('Analysis section loaded')}
            >
            ...
            <TabsTrigger 
              ...
              onClick={() => toast.info('AI Recommendations loaded')}
            >
            ...
            <TabsTrigger 
              ...
              onClick={() => toast.info('Monitoring section loaded')}
            >
            ...
            <TabsTrigger 
              ...
              onClick={() => toast.info('AI Assistant opened')}
            >
